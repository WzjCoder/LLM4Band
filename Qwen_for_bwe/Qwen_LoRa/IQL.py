...
pickle_path = '/your_path/training_dataset_pickle/range_average_training_dataset_pickle.pickle'
evaluation_dataset_path = '/your_path/evaluate_dataset'
...
class TrainConfig:
    # Experiment
    device: str = "cuda:1"
    env: str = "qwen0.5B-new-estimator-range_average"
