...
def main():
    ...
    action_dim = 1
    device = 'cuda:0'
    torch_model_dir = '/home/wangzhijian/bandwidth_estimation/solution/Qwen_for_bwe/Qwen_LoRa/checkpoints_iql/IQL-qwen0.5B-estimator-range_average/checkpoint_1000000.pt'
    ...
    save_path = './merged_model/Qwen_merged_model.pth'
