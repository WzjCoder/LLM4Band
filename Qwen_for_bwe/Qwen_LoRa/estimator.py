...
from module import StateEncoder, BweHead, BweHead2
...
class bwe_agent(nn.Module):
    def __init__(self, max_action, state_dim, action_dim, device):
        ...
        self.llm = LoraModel(AutoModelForCausalLM.from_pretrained(Qwen1_5_weight_hf_format_dir, use_cache=False, device_map=self.device), 
                            Lora_config, 
                            "default")
