...
from .heuristic import HeuristicEstimator
import logging
...
bob_model_path = '/app/model/bob.pth'

class BobEstimator(object):
    def __init__(self, model_path=bob_model_path, step_time=60): # Make sure to push model and change the name of the model
        # model parameters
        state_dim = 11
        action_dim = 4
