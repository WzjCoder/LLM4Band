...
from .gcc import GCCEstimator
import logging

hrcc_model_path = "./model/pretrained_model.pth"

# logging.basicConfig(filename='bandwidth_estimator.log', level=logging.DEBUG)

class HRCCEstimator(object):
    def __init__(self, model_path=hrcc_model_path, step_time=200):
        '''
    ...
    def get_estimated_bandwidth(self)->int:
        ...
        self.gcc_decision, self.overuse_flag = self.gcc_estimator._get_estimated_bandwidth()
